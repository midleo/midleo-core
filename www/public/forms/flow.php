                ...
                <div role="tabpanel">
                    <ul class="nav nav-tabs customtab" role="tablist">
                        ...
                        <li class="nav-item"><a class="nav-link <?php echo $ienv==0?"active":"";?>"
                                href="#flow<?php echo $valenv['nameshort'];?>"
 ...
 $ienv++;}   ?>
                    ...
                    <div class="tab-content form-material">
                        ...
                        <div role="tabpanel" class="tab-pane <?php echo $ienv==0?'active':"";?>"
                            id="flow<?php echo $valenv['nameshort'];?>">
                            <?php echo Tpl::flow($before="flow_",$after="_".$valenv['nameshort']); ?>
...
<input name="reqtype" type="text" value="flow" style="display:none;">