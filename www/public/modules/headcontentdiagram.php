            ...
            <ul class="navbar-nav me-auto mb-lg-0">
                <ol class="breadcrumb hide-xs">
                    ...
                    <li class="breadcrumb-item active"><a
                            href="/diagrams/category/<?php echo $blogcatname;?>"><?php echo $blogcat;?></a></li>
                    <?php } ?>
                </ol>
            ...
            <ul class="navbar-nav mb-lg-0 nlinks">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu usrdrdown" aria-labelledby="usrdrdown">
                        ...
                        <?php if(!empty($_SESSION["user"])){?> <li><a href="/logout"
...
<aside class="left-sidebar" ng-app="ngSysApp" ng-controller="ngsysCtrl"><?php include "sidebardiagrams.php";?></aside>