...
<link href="/<?php echo $website['corebase'];?>assets/css/midleostyle.php?&c=<?php echo $website["color"];?>&v=<?php echo filemtime('./assets/css/midleostyle.php');?>" rel="stylesheet" type="text/css" />
