...
.sidebar-nav ul li ul li a{padding:6px 15px;white-space: pre-wrap;}
...
.sidebar-nav > ul > li > ul > li:hover > a{background:#0000001A;border-radius:3px;}
...
.mini-sidebar .sidebar-nav #sidebarnav > li:hover > a i{color:#'.$thiscolor.'}
