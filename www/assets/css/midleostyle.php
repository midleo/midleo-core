...
body[data-color="light"] .page-wrapper{background:#f9f9fa;padding-bottom:60px}
...
.navtop span.close{position: relative;color: #fff;right: -244px;top: -38px;display:none;}
