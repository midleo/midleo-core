        ...
        <div class=" ngctrl" >
            <div class="row">
                <div class="col-md-3 position-relative">
                    <input type="text" ng-model="search" class="form-control  topsearch" placeholder="find a document">
                ...
                <div class="col-md-9 text-end">
                    <div>
                        <a data-bs-toggle="modal" href="#mnewimp" class="waves-effect waves-light btn btn-light"><svg
                                data-bs-toggle="tooltip" data-bs-placement="top" title="Import documents"
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" >
                        <div class="row">
                            <div class="col-sm-7">
                                <input type="text" ng-model="doc.fileloc" class="form-control" placeholder="File location"
                                    aria-label="File location">
                            </div>
                            <div class="col-sm">
                                <select class="form-select" ng-model="doc.filetype" aria-label="document type">
                            ...
                            <div class="col-sm">
                                <button type="button" class="btn btn-light" ng-click="scandir()">Scan</button>
                            </div>
                        </div>
                        <hr>
                        <ul class="list-group listdoc list-group-flush" style="width:100%;min-height:300px;max-height:500px;overflow-x:hidden;overflow-y:scroll;" ng-if="doclist" >
                           <li class="list-group-item" ng-repeat="(key, val) in doclist" ng-class="key<=tempkey?'list-group-item-success':''">{{val}}</li>
                        </ul>
                    </div>
                    <div class="modal-footer">
                        <button class="btn btn-info btn-sm" ng-if="doclist" type="button" ng-click="startImport()"><i
