            ...
            <div class="card-body p-0">
                <div class="row">
                    <div class="col-md-9">
                        <ul class="nav nav-tabs customtab" role="tablist">
                            ...
                            <li class="nav-item"> <a class="nav-link" data-bs-toggle="tab" href="#chl" role="tab"><span
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="chl" role="tabpanel">
                        <table id="data-table2" class="table table-hover stylish-table" aria-busy="false"
                            style="margin-top:0px !important;">
                            <thead>
                                <tr>
                                    <th style="width:40px"></th>
...
<div id="ngApp" ng-app="ngApp" ng-controller="ngCtrl">
    <div class="row p-0">
        <div class="col-md-4 position-relative">
            <input type="text" ng-model="search" class="form-control topsearch" placeholder="Find an Qmanager">
            <span class="searchicon"><svg class="midico midico-outline">
                    <use href="/assets/images/icon/midleoicons.svg#i-search"
                        xlink:href="/assets/images/icon/midleoicons.svg#i-search" />
                </svg></span>
...
var messdata = [
    { x: new Date('<?php echo date("Y-m-d H:i:s",strtotime(date("Y-m-d H:i:s")." -15 minutes"));?>'),y: <?php echo rand(0,100);?>},
    { x: new Date('<?php echo date("Y-m-d H:i:s",strtotime(date("Y-m-d H:i:s")." -10 minutes"));?>'),y: <?php echo rand(0,100);?>},
    { x: new Date('<?php echo date("Y-m-d H:i:s",strtotime(date("Y-m-d H:i:s")." -5 minutes"));?>'),y: <?php echo rand(0,100);?>},
];
var config = {
    type: 'bar',
    data: {
