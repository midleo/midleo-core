...
<div class="card" id="ngApp" ng-app="ngApp" ng-controller="ngCtrl">
    <div class="card-header border-bottom">
        <div class="row">
            <div class="col-md-6 text-start">
                <h4 style="margin-bottom: 0px;line-height: 34px;">Request workflow</h4>
            </div>
            <div class="col-md-6" style="text-align:right;">
                <input id="wid" name="wid" value="<?php echo $thisarray["p1"];?>" type="text" style="display:none;">
                <?php if($zobj["wowner"]==$_SESSION["user"]){?>
                <button type="button" onclick="_saveFlowchart();" class="btn btn-light"><svg
                ...
                <a href="/smanagement" class="btn btn-light" target="_parent"><i
                        class="mdi mdi-history"></i>&nbsp;Back</a>&nbsp;
                <?php if($zobj["wowner"]==$_SESSION["user"]){?><button onclick="_delFlowchart();" type="button"
                    name="delwf" class="btn btn-light"><svg class="midico midico-outline">
  ...
  ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4"><input type="number" min="0" oninput="validity.valid||(value='');" id="wfcost"
                            value="<?php echo $zobj["wfcost"];?>" class="form-control">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="form-control-label text-lg-left col-md-4"><?php echo $website['currency_unit'];?>
                    </div>
                </div>
                <br><br>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <div class="toggle-switch">
                        <input id="haveappr" name="haveappr" value="1" type="checkbox" <?php if($zobj['haveappr']==1){?>
                            checked="checked" <?php } ?> style="display:none;">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body form-material">
                                <div class="form-group row">
                                    <label class="form-control-label text-lg-right col-md-3" for="nmnameen">Name</label>
                                    <div class="col-md-9"><input type="text" class="form-control" id="nmnameen">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="form-control-label text-lg-right col-md-3" for="nmassign">Assign
                                        to</label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="toggle-switch">
                                            <input id="checkapprove" value="1" type="checkbox" style="display:none;">
                                            <label for="checkapprove" class="ts-helper">Aproval (optional)</label>
                                        </div>
                                    </div>
                                </div>
                                <?php } ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="toggle-switch">
                                            <input id="canconfirm" value="1" type="checkbox" style="display:none;">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="toggle-switch">
                                            <input id="candeploy" value="1" type="checkbox" style="display:none;">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="toggle-switch">
                                            <input id="canefforts" value="1" type="checkbox" style="display:none;">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="toggle-switch">
                                            <input id="canchtask" value="1" type="checkbox" style="display:none;">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body form-horizontal form-material">
                                <div class="form-group row usersdiv">
                                    ...
                                    <div class="col-md-6"><input type="text" class="form-control" id="autocomplete">
...
<div id="ngApp" ng-app="ngApp" ng-controller="ngCtrl">
    ...
    <ul class="row" ng-init="getAllservice('<?php echo $wid;?>')" style="padding:0 15px;">
        ...
        <li class="col-md-4" id="contloaded" dir-paginate="d in names | filter:search | itemsPerPage:12" ng-class="hide"
            ...
            <div ng-click="redirect('/smanagement/'+d.wid)" class="card waves-effect waves-dark" style="width:100%;">
                ...
                <div class="card-body">
                    ...
                    <div class="row ">
                        <div class="col-md-12 text-start cardwf">
                            ...
                            <p class="card-text">
                                {{ d.winfo | limitTo:4*textlimit }}{{d.winfo.length > 4*textlimit ? '...' : ''}}</p>
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12" ng-if="pjinfo.formid"><br><br>
                                                    ...
                                                    <div class="alert alert-light">You are required to fill additional form input once you open this project.</div>
                                                </div>
                                            </div>
            ...
            <div class="card-body">
                <form name="projform" action="" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9"><textarea name="projinfo" class="form-control textarea"><?php echo $zobj["projinfo"];?></textarea></div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                <input type="text" class="form-control text-center"
                                    placeholder="Start Date" name="projstart" value="Start: <?php echo $zobj["projstartdate"];?>" disabled />
                                <input type="text" class="form-control text-center"
                                    placeholder="End Date" name="projend" value="End: <?php echo $zobj["projduedate"];?>" disabled />
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 "><label class="form-control-label"><b><?php echo $zobj["totalcost"];?></b> <?php echo $website["currency_unit"];?></label></div>
                    </div>
...
<div class="card">
<div class="card-header"><h4>Opened requests </h4></div>
            <div class="card-body">
            <?php foreach(json_decode($zobj["reqinfo"],true) as $key=>$val){
                ...
                <table class="table">
                   ...
                   <tr><td><a href="/browse/req/<?php echo $valin["sname"];?>" target="_parent"><?php echo $valin["reqname"];?></a></td><td class="text-end"><?php echo $valin["reqapp"];?></td></tr>
                    <?php } ?>
                </table>
                <?php }
            } ?>
