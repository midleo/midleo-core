...
class Class_api
{
    public static function getPage($thisarray)
    {
        ...
        if (!empty($thisarray["p1"]) && !empty($_SESSION['user'])) {
            switch ($thisarray["p1"]) {
                case 'add':Class_api::add($thisarray["p2"]);
                    break;
                case 'addvar':Class_api::addVar();
                    break;
                case 'addfte':Class_api::addfte();
                    break;
                case 'addappsrv':Class_api::addServer();
                    break;
                case 'dell':Class_api::dell($thisarray["p2"]);
                    break;
                case 'duplicate':Class_api::duplicate($thisarray["p2"]);
                    break;
                case 'tasks':Class_api::tasks($thisarray["p2"]);
                    break;
                case 'calendar':Class_api::getCal($thisarray["p2"], $thisarray["p3"]);
                    break;
                case 'delvar':Class_api::delVar();
                    break;
                ...
                case 'groups':Class_api::getGroups($thisarray["p2"]);
                    break;
                case 'dellfte':Class_api::delfte();
                    break;
                case 'dellappsrv':Class_api::dellAppsrv();
                    break;
                case 'dellflows':Class_api::dellFlows();
                    break;
                case 'dellflow':Class_api::dellFlow();
                    break;
                case 'update':Class_api::update($thisarray["p2"]);
                    break;
                case 'updatevar':Class_api::updateVar();
                    break;
                case 'updatefte':Class_api::updatefte();
                    break;
                case 'updappsrv':Class_api::updAppsrv();
                    break;
                case 'updsrv':Class_api::updSrv();
                    break;
                case 'read':Class_api::read($thisarray["p2"], $thisarray["p3"]);
                    break;
                case 'readfte':Class_api::readfte($thisarray["p2"]);
                    break;
                case 'readflows':Class_api::readFlows();
                    break;
                case 'updatesystemnest':Class_api::updateSystemnest();
                    break;
                case 'readflow':Class_api::readFlow();
                    break;
                case 'users':Class_api::getUsers($thisarray["p2"]);
                    break;
                case 'addflow':Class_api::addFlow();
                    break;
                ...
                case 'dns':Class_api::DNS($thisarray["p2"]);
                    break;
                case 'readpack':Class_api::readPackage();
                    break;
                ...
                case 'getallusrgr':Class_api::readAllusrGr($thisarray["p2"]);
                    break;
                case 'mqsc':Class_api::createMqsc($thisarray["p2"], $thisarray["p3"]);
                    break;
                case 'auth':Class_api::createAuth($thisarray["p2"], $thisarray["p3"]);
                    break;
                case 'dlqh':Class_api::createDlqh($thisarray["p2"]);
                    break;
                case 'fte':Class_api::createFte($thisarray["p2"], $thisarray["p3"]);
                    break;
