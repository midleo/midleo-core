...
<span data-bs-toggle="tooltip" data-bs-placement="top" title="Define new Subscription definitions"><button type="button" class="waves-effect waves-light btn btn-info" data-bs-toggle="modal" href="#modal-obj-form" ng-click="showCreateForm()"><svg class="midico midico-outline"><use href="/assets/images/icon/midleoicons.svg#i-add" xlink:href="/assets/images/icon/midleoicons.svg#i-add"/></svg>&nbsp;New</button></span>
  </div>
</div><br>
  <div class="card ">
...
<div class="row"><div class="col-md-12">
  ...
  <div class="modal" id="modal-obj-form" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
      ...
      <div class="modal-header"><h4>Define Subscription definition</h4></div>
...
<?php foreach($zobjfte as $val) { echo '<option value="'.$val["qmname"].'">'.$val['qmname'].' ('.$val['serverdns'].')</option>'; } ?>
 ...
 <?php } ?>  
            ...
            <div class="form-group row">
              ...
              <div class="col-md-9"><input ng-model="mq.topicobj" type="text" class="form-control"></div>
            </div>
            <div class="form-group row">
              <label class="form-control-label text-lg-right col-md-3" >DEST</label>
              <div class="col-md-9"><input ng-model="mq.dest" type="text" class="form-control"></div>
            </div>
            <div class="form-group row">
              <label class="form-control-label text-lg-right col-md-3" >DESTQMGR</label>
              <div class="col-md-9"><input ng-model="mq.destqmgr" type="text" class="form-control"></div>
            </div>
            <div class="form-group row">
              <label class="form-control-label text-lg-right col-md-3" >SELECTOR</label>
              <div class="col-md-9"><textarea ng-model="mq.selector" class="form-control" rows="3"></textarea></div>
            </div>
            
          </div>
          <div class="modal-footer" style="display:flow-root list-item;">
          <div class="float-start"><a href="https://www.google.com/search?q=ibm+mq+define+sub" target="_blank" class="waves-effect waves-light btn btn-light btn-sm">Information about Subscription</a></div>
          <div class="float-end">
