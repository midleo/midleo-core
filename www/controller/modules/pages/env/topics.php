...
<span data-bs-toggle="tooltip" data-bs-placement="top" title="Define new Topic definitions"><button type="button" class="waves-effect waves-light btn btn-info" data-bs-toggle="modal" href="#modal-obj-form" ng-click="showCreateForm()"><svg class="midico midico-outline"><use href="/assets/images/icon/midleoicons.svg#i-add" xlink:href="/assets/images/icon/midleoicons.svg#i-add"/></svg>&nbsp;New</button></span>
</div>
</div><br>
  <div class="card ">
...
<div class="row"><div class="col-md-12">
  ...
  <div class="modal" id="modal-obj-form" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
      ...
      <div class="modal-header"><h4>Define Topic definition</h4></div>
...
<?php foreach($zobjfte as $val) { echo '<option value="'.$val["qmname"].'">'.$val['qmname'].' ('.$val['serverdns'].')</option>'; } ?>
 ...
 <?php } ?>  
            ...
            <div class="form-group row">
              ...
              <div class="col-md-9"><input ng-model="mq.topicstr" type="text" class="form-control"></div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-9"><select class="form-control" ng-model="mq.defpsist"><option value="">ASPARENT</option><option value="yes">Yes</option><option value="no">No</option></select></div>
            </div>
            <div class="form-group row">
              <label class="form-control-label text-lg-right col-md-3" >PUB</label>
              <div class="col-md-9"><select class="form-control" ng-model="mq.pub"><option value="">ASPARENT</option><option value="enabled">Enabled</option><option value="disabled">Disabled</option></select></div>
            </div>
            <div class="form-group row">
              <label class="form-control-label text-lg-right col-md-3" >PUBSCOPE</label>
              <div class="col-md-9"><select class="form-control" ng-model="mq.pubscope"><option value="">ASPARENT</option><option value="qmgr">Qmgr</option><option value="all">All</option></select></div>
            </div>
            <div class="form-group row">
              <label class="form-control-label text-lg-right col-md-3">SUB</label>
              <div class="col-md-9"><select class="form-control" ng-model="mq.sub"><option value="">ASPARENT</option><option value="enabled">Enabled</option><option value="disabled">Disabled</option></select></div>
            </div>
            <div class="form-group row">
              <label class="form-control-label text-lg-right col-md-3" >SUBSCOPE</label>
              <div class="col-md-9"><select class="form-control" ng-model="mq.subscope"><option value="">ASPARENT</option><option value="qmgr">Qmgr</option><option value="all">All</option></select></div>
            </div>
            <div class="form-group row">
              <label class="form-control-label text-lg-right col-md-3" >WILDCARD</label>
              <div class="col-md-9"><select class="form-control" ng-model="mq.wildcard"><option value="">PASSTHRU</option><option value="block">Block</option></select></div>
            </div>
          </div>
          <div class="modal-footer" style="display:flow-root list-item;">
          <div class="float-start"><a href="https://www.google.com/search?q=ibm+mq+define+topic" target="_blank" class="waves-effect waves-light btn btn-light btn-sm">Information about Topic</a></div>
          <div class="float-end">
