            ...
            <div class="card-body">
                <form name="projform" action="" enctype="multipart/form-data" method="post">
                    <div class="form-group row">
                        <label class="form-control-label text-lg-left col-md-3">Name</label>
                        <div class="col-md-9"><input required name="appname" id="appname" type="text"
                                class="form-control" value=""></div>
                    </div>
                    <div class="form-group row">
                        <label class="form-control-label text-lg-left col-md-3">Identifier</label>
                        <div class="col-md-9"><input required name="appcode" type="text" id="appcode"
                                class="form-control" value=""></div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="form-control-label text-lg-left col-md-3">Description</label>
                        <div class="col-md-9"><textarea name="appinfo" class="form-control textarea"></textarea></div>
                    </div>
...
if($zobjin = $qin->fetch(PDO::FETCH_ASSOC)){ ?>
                <div class="contact-widget position-relative">
                    <a href="/browse/user/<?php echo $zobj["owner"];?>" target="_blank"
                        ...
                        <div class="user-img position-relative d-inline-block me-2">
                            <img src="<?php echo !empty($zobjin["avatar"])?'/'.$website['corebase'].substr($zobjin["avatar"],1) : '/'.$website['corebase'].'assets/images/avatar.svg' ;?>"
        ...
        <div class="card">
            ...
            <div class="card-body  p-<?php echo $_GET["type"]=="edit"?"1":"0";?>">
                ...
                <div class="form-group row usersdiv"
                    ng-init="readappgr('<?php echo $_GET["app"];?>','<?php echo $_SESSION['user'];?>')">
                    <div class="col-md-8">
   ...
   foreach(json_decode($zobj["appusers"],true) as $key=>$val){?>
                    ...
                    <a href="/browse/user/<?php echo $key;?>" target="_blank"
                        class="py-3 px-2 border-bottom d-block text-decoration-none">
                        <div class="user-img position-relative d-inline-block me-2">
                            <img src="<?php echo !empty($val["uavatar"])?'/'.$website['corebase'].'assets/images/users/'.$val["uavatar"] : '/'.$website['corebase'].'assets/images/avatar.svg' ;?>"
            ...
            <table class="table table-vmiddle table-hover stylish-table mb-0">
                ...
                <tr ng-hide="contentLoaded">
                    ...
                    <tr id="contloaded" class="hide"
                        ...
                        pagination-id="prodx">
                        <td class="text-center"><a ng-click="addrecent('/env/apps',d.appcode,d.appname)"
                                style="cursor:pointer;">{{ d.appcode }}</a></td>
                        <td class="text-center">{{ d.appname }}</td>
                        <td class="text-center">{{ d.owner }}</td>
                        <td class="text-center"><span ng-if="d.tags" class="badge badge-secondary me-1 mt-1"
                                ng-repeat="(key,val) in d.tags"><a class="text-white"
