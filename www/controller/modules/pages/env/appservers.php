                    ...
                    <tr id="contloaded" class="hide"
                        ...
                        <td class="text-center">
                            <div class="text-start d-grid gap-2 d-md-block">
                                <button type="button" ng-click="readOneAppserv(d.id,'<?php echo $thisarray['p2'];?>')"
                                    class="btn waves-effect btn-light btn-sm"><i
                                        class="mdi mdi-pencil mdi-18px"></i></button>
                                <?php if($_SESSION['user_level']>=3){?>
                                <button type="button"
                                    ng-click="duplappsrv(d.id,'<?php echo $_SESSION['user'];?>','<?php echo $thisarray['p2'];?>')"
                                    class="btn btn-light btn-sm bg waves-effect" title="Duplicate"><i
                                        class="mdi mdi-content-duplicate mdi-18px"></i></button>
                                <button type="button"
                                    ng-click="delappsrv(d.id,'<?php echo $_SESSION['user'];?>','<?php echo $thisarray['p2'];?>')"
                                    class="btn waves-effect btn-light btn-sm"><i
                        ...
                        <form name="form" ng-app>
                            <div class="modal-body container form-material"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9"><input ng-model="serv.appsrvname" type="text"
                                            class="form-control"></div>
                                </div>
                                <div class="form-group row">
                                    <label class="form-control-label text-lg-right col-md-3">Type</label>
                                    <div class="col-md-9"><select class="form-control" ng-model="serv.serv_type">
                                            <option value="">Please select</option>
                                            <?php foreach($typesrv as $keyin=>$valin){?><option
                                                value="<?php echo $keyin;?>"><?php echo $valin;?></option><?php } ?>
                                        </select></div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="form-control-label text-lg-right col-md-3" data-trigger="hover"
                                        ng-class="{'has-error':!serv.port}">Port</label>
                                    <div class="col-md-8"><input ng-model="serv.port" type="text" class="form-control">
                                    </div>
                                    <div class="col-md-1" style="padding-left:0px;"><button type="button"
                                            class="btn btn-light" data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="Port address on which Qmanager/FTE command QM/Broker is listening"><i
                                                class="mdi mdi-information-variant mdi-18px"></i></button></div>
                                </div>
                                <div class="form-group row" ng-show="serv.serv_type=='qm' || serv.serv_type=='fte'">
                                    ...
                                    <div class="col-md-9"><input ng-model="serv.qmname" type="text"
                                            class="form-control"></div>
                                </div>
                                <div class="form-group row" ng-show="serv.serv_type=='qm' || serv.serv_type=='fte'">
                                    <label class="form-control-label text-lg-right col-md-3">Channel</label>
                                    <div class="col-md-8"><input ng-model="serv.qmchannel" type="text"
                                            class="form-control"></div>
                                    <div class="col-md-1" style="padding-left:0px;"><button type="button"
                                            class="btn btn-light" data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="Channel name. In case of FTE agent - Command Qmanager Channel name"><i
                                                class="mdi mdi-information-variant mdi-18px"></i></button></div>
                                </div>
                                <div class="form-group row" ng-show="serv.serv_type=='fte'">
                                    <label class="form-control-label text-lg-right col-md-3">Fte agent</label>
                                    <div class="col-md-9"><input ng-model="serv.agentname" type="text"
                                            class="form-control"></div>
                                </div>
                                <div class="form-group row" ng-show="serv.serv_type=='ibmiib'">
                                    ...
                                    <div class="col-md-9"><input ng-model="serv.brokername" type="text"
                                            class="form-control"></div>
                                </div>
                                <div class="form-group row" ng-show="serv.serv_type=='ibmiib'">
                                    <label class="form-control-label text-lg-right col-md-3">Exec group</label>
                                    <div class="col-md-9"> <input ng-model="serv.execgname" type="text"
                                            class="form-control"></div>
                                </div>
                                <div class="form-group row" ng-show="serv.serv_type=='tibems'">
                                    ...
                                    <div class="col-md-9"> <input ng-model="serv.srvuser" type="text"
                                            class="form-control"></div>
                                </div>
                                <div class="form-group row" ng-show="serv.serv_type=='tibems'">
                                    <label class="form-control-label text-lg-right col-md-3">Password</label>
                                    <div class="col-md-9"> <input ng-model="serv.srvpass" type="password"
                                            class="form-control"></div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="toggle-switch">
                                            <input id="sslenabled" value="1" ng-model="serv.sslenabled" type="checkbox"
                                                ng-checked="serv.sslenabled=='1'" style="display:none;">
                                ...
                                <div class="form-group row" ng-show="serv.sslenabled=='1'">
                                    ...
                                    <div class="col-md-9"> <input ng-model="serv.sslkey" type="text"
                                            class="form-control"></div>
                                </div>
                                <div class="form-group row" ng-show="serv.sslenabled=='1'">
                                    <label class="form-control-label text-lg-right col-md-3">SSL password</label>
                                    <div class="col-md-9"> <input ng-model="serv.sslpass" type="text"
                                            class="form-control"></div>
                                </div>
                                <div class="form-group row" ng-show="serv.sslenabled=='1'">
                                    <label class="form-control-label text-lg-right col-md-3">SSL Cipher</label>
                                    <div class="col-md-9"> <input ng-model="serv.sslcipher" type="text"
                                            class="form-control"></div>
                                </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" id="btn-create-obj"
                                    ...
                                    ng-click="form.$valid && addappsrv('<?php echo $_SESSION['user'];?>','<?php echo $thisarray['p2'];?>')"><i
                                        class="mdi mdi-check"></i>&nbsp;Create</button>
                                <button type="button" id="btn-update-obj"
                                    class="waves-effect waves-light btn btn-info btn-sm"
                                    ng-click="updappsrv('<?php echo $_SESSION['user'];?>','<?php echo $thisarray['p2'];?>')"><i
