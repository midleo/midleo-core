...
<div class="row">
                    ...
                    <tr id="contloaded" class="hide"
                        ...
                        <td class="text-center">
                            <div class="text-start d-grid gap-2 d-md-block">
                                <button type="button" ng-click="readOneTib('queue',d.id,d.proj)" style=""
                                    class="btn btn-light btn-sm bg waves-effect"><i
                                        class="mdi mdi-pencil mdi-18px"></i></button>
                                <?php if($_SESSION['user_level']>="3"){?>
                                <button type="button"
                                    ng-click="duplicate('tibco','queue',d.id,'<?php echo $_SESSION['user'];?>','<?php echo $thisarray['p2'];?>')"
                                    class="btn btn-light btn-sm bg waves-effect" title="Duplicate"><i
                                        class="mdi mdi-content-duplicate mdi-18px"></i></button>
                                <button type="button"
                                    ng-click="deletetib('queue',d.id,d.name,d.proj,'<?php echo $_SESSION['user'];?>')"
 ...
 ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9"><input ng-model="tibq.maxredel" type="number"
                                            class="form-control"></div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="toggle-switch">
                                            <input id="exclusive" value="1" ng-model="tibq.exclusive" type="checkbox"
                                                ng-checked="tibq.exclusive=='1'" style="display:none;">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" id="btn-create-obj"
                                    ...
                                    ng-click="form.$valid && createtib('queue','<?php echo $thisarray['p2'];?>','<?php echo $_SESSION['user'];?>')"><i
                                        class="mdi mdi-check"></i>&nbsp;Create</button>
                                <button type="button" id="btn-update-obj"
                                    class="waves-effect waves-light btn btn-info btn-sm"
                                    ng-click="updatetib('queue','<?php echo $thisarray['p2'];?>','<?php echo $_SESSION['user'];?>')"><i
