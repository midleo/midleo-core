...
<div class="col-md-8"><input id="tags" name="tags" data-role="tagsinput" type="text" class="form-control"></div>
...
<label class="form-control-label text-lg-right col-md-3">Place name</label>
<div class="col-md-9">
<input name="place" type="text" value="<?php echo $zobj["placename"];?>" class="form-control">
</div>
</div>
<div class="form-group row">
<label class="form-control-label text-lg-right col-md-3">Tags</label>
<div class="col-md-8"><input id="tags" name="tags" data-role="tagsinput" type="text" value="<?php echo $zobj["tags"];?>" class="form-control"></div>
<div class="col-md-1" style="padding-left:0px;"><button type="button" class="btn btn-light" data-bs-toggle="tooltip" data-bs-placement="top" title="You can search this object with tags" ><i class="mdi mdi-information-variant mdi-18px"></i></button></div>
</div>
<div class="form-group row">
<label class="form-control-label text-lg-right col-md-3">Region</label>
...
<option value="">Please select</option>
<?php 
foreach($countries as $keyin=>$valin) { ?><option value="<?php echo $keyin;?>" <?php echo $zobj["plregion"]==$keyin?"selected":"";?>><?php echo $valin;?></option><?php  }
?>
</select>
</div>
</div>
...
<option value="datacenter" <?php echo $zobj["pltype"]=="datacenter"?"selected":"";?>>a Datacenter</option>
<option value="closet" <?php echo $zobj["pltype"]=="closet"?"selected":"";?>>a Closet</option>
<option value="desk" <?php echo $zobj["pltype"]=="desk"?"selected":"";?>>a Desk</option>
<option value="cloud" <?php echo $zobj["pltype"]=="cloud"?"selected":"";?>>Cloud Provider</option>
</select>
</div>
</div>
<div class="form-group row">
<label class="form-control-label text-lg-right col-md-3">Contact person</label>
<label class="form-control-label text-lg-left col-md-6 chcontact"><a href="/browse/<?php echo explode("#",$zobj["plcontact"])[0];?>/<?php echo explode("#",$zobj["plcontact"])[1];?>" target="_blank"><?php echo explode("#",$zobj["plcontact"])[2];?></a></label>
<div class="form-control-label text-lg-right col-md-3 chcontact"><a onclick="$('.chcontact').hide();$('.addcontact').show();">Change</a></div>
...
<?php foreach($zobj as $val) { ?>
    <tr><td><a href="/browse/server/<?php echo $val['serverid'];?>"><?php echo $val['serverdns'];?></a></td><td><?php echo $val['servertype'];?></td><td> </td></tr>
<?php } ?>
</tbody>
</table>
<?php } ?>
...
<div class="card-body p-0">
        ...
        <table class="table table-vmiddle table-hover stylish-table mb-0" style="margin-top:0px !important;">
            <thead>
                <tr>
