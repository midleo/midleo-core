<?php if(empty($thisarray['p2'])){ include "applist.php"; } else { ?>
  ...
  <div class="col-md-3 position-relative">
      <input type="text" ng-model="search" class="form-control topsearch" placeholder="Find a definition">
...
<span data-bs-toggle="tooltip" data-bs-placement="top" title="Deploy package on server"><a ng-show="selectedid.length" data-bs-toggle="modal"  class="waves-effect waves-light btn btn-light" href="#modal-depl-form" ng-click="showDeployForm()"><i class="mdi mdi-upload"></i></a></span>
<?php if ($_SESSION['user_level'] >= 3 && !in_array($thisarray['p1'], array("packages", "appservers", "servers", "import", "deploy", "flows", "fte"))) {?><span><button data-bs-toggle="tooltip" data-bs-placement="top" title="Export the objects in excel" type="button" class="waves-effect waves-light btn btn-light" ng-click="exportData('<?php echo $thisarray['p1']; ?>')">Export&nbsp;<svg class="midico midico-outline" ><use href="/assets/images/icon/midleoicons.svg#i-up" xlink:href="/assets/images/icon/midleoicons.svg#i-up"/></svg></button> </span><?php }?>
 <span data-bs-toggle="tooltip" data-bs-placement="top" title="Define new Qmanager definition"><button type="button" class="waves-effect waves-light btn btn-info" data-bs-toggle="modal" href="#modal-obj-form" ng-click="showCreateForm()"><svg class="midico midico-outline" ><use href="/assets/images/icon/midleoicons.svg#i-add" xlink:href="/assets/images/icon/midleoicons.svg#i-add"/></svg>&nbsp;New</button></span>
  </div>
</div><br>
  <div class="card ">
...
<table class="table table-vmiddle table-hover stylish-table mb-0">
  ...
  <div class="modal" id="modal-obj-form" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
      ...
      <div class="modal-header"><h4>Define QM definition</h4></div>
        <form name="form" ng-app>
          <div class="modal-body">
            <div role="tabpanel">
              ...
              <div class="tab-content form-horizontal form-material" style="width:100%;min-height:300px;max-height:500px;overflow-x:hidden;overflow-y:scroll;">
                <div role="tabpanel" class="tab-pane active" id="base" >
                  
                  
                  <div class="form-group row">
                    <label class="form-control-label text-lg-right col-md-3"  >Active</label>
                    <div class="col-md-9"><select class="form-control" ng-model="mq.active"><option value="">Please select</option><option value="yes">Yes</option><option value="no">No</option></select></div>
                  </div>
...
<?php foreach($zobjfte as $val) { echo '<option value="'.$val["qmname"].'">'.$val['qmname'].' ('.$val['serverdns'].')</option>'; } ?>
 ...
 <?php } ?>  
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-9"><select class="form-control" ng-init="mq.type='qm'" ng-model="mq.type"><option value="qm">Qmanager</option><option value="group">Group</option></select></div>
                  </div>
                  <div class="form-group row">
                    <label class="form-control-label text-lg-right col-md-3"  >ENV</label>
                    <div class="col-md-9"><select class="form-control" ng-model="mq.env"><option value="">Please select</option>
                      <?php foreach($menudataenv as $key=>$val){  ?>
                      <option value="<?php echo $val['nameshort'];?>"><?php echo $val['name'];?></option>
                      <?php } ?>
                  ...
                  <div class="form-group row" ng-show="mq.type=='group'">
                    ...
                    <div class="col-md-9"><input ng-model="mq.name" type="text" class="form-control"></div>
                  </div> 
                ...
                <div role="tabpanel" class="tab-pane" id="default">
                  <div class="form-group row">
                    ...
                    <div class="col-md-9"><input ng-model="mq.deadq" type="text" class="form-control"></div>
                  </div>
                  <div class="form-group row">
                    <label class="form-control-label text-lg-right col-md-3"  >REPOS</label>
                    <div class="col-md-9"><input ng-model="mq.repos" ng-maxlength="48" type="text" class="form-control"></div>
                  </div>
                  <div class="form-group row">
                    <label class="form-control-label text-lg-right col-md-3"  >REPOSNL</label>
                    <div class="col-md-9"><input ng-model="mq.reposnl" type="text" class="form-control"></div>
                  </div>
                  <div class="form-group row">
                    <label class="form-control-label text-lg-right col-md-3"  >CCSID</label>
                    <div class="col-md-9"><input ng-model="mq.ccsid" type="text" class="form-control"></div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    <label class="form-control-label text-lg-right col-md-3"  >MAXUMSGS</label>
                    <div class="col-md-9"><input ng-model="mq.maxumsgs" type="text" class="form-control"></div>
                  </div>
                  <div class="form-group row">
                    <label class="form-control-label text-lg-right col-md-3"  >SSLKEYR</label>
                    <div class="col-md-9"><input ng-maxlength="256" ng-model="mq.sslkeyr" type="text" class="form-control"></div>
                  </div>
                  <div class="form-group row">
                    <label class="form-control-label text-lg-right col-md-3"  >CERTLABL</label>
                    <div class="col-md-9"><input ng-model="mq.certlabl" type="text" class="form-control"></div>
                  </div>
          ...
          <div class="float-start"><a href="https://www.google.com/search?q=ibm+mq+alter+qmgr" target="_blank" class="waves-effect waves-light btn btn-light btn-sm">Information about Qmanager</a></div>
          <div class="float-end">
          <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal"><svg class="midico midico-outline"><use href="/assets/images/icon/midleoicons.svg#i-x" xlink:href="/assets/images/icon/midleoicons.svg#i-x"/></svg>&nbsp;Close</button>
            <button type="button" id="btn-mqsc-obj" class="waves-effect waves-light btn btn-primary btn-sm" ng-click="mqsc('<?php echo $thisarray['p1'];?>',mq.proj,'<?php echo $_SESSION['user'];?>','<?php echo $page;?>')" ng-href="{{ url }}"><i class="mdi mdi-download"></i>&nbsp;Create mqsc</button>
