...
<table class="table table-vmiddle table-hover stylish-table mb-0">
    ...
    <tbody ng-init="getAll('<?php echo $thisarray['p1'];?>','<?php echo $thisarray['p2'];?>','<?php echo $page;?>')">
      ...
      <tr id="contloaded" class="hide" dir-paginate="d in names | filter:search | orderBy:'qm':reverse | itemsPerPage:10" pagination-id="prodx" ng-hide="d.qm==''">
        ...
        <button type="button" ng-click="readOne('<?php echo $thisarray['p1'];?>',d.qid,d.qmid,'<?php echo $thisarray['p2'];?>','<?php echo $page;?>')" style="" class="btn btn-light btn-sm bg waves-effect"><i class="mdi mdi-pencil mdi-18px"></i></button>
          <?php if($_SESSION['user_level']>="3"){?>
            ...
            <button type="button" ng-click="delete('<?php echo $page=="env"?$thisarray['p1']:$thisarray['p3'];?>',d.qid,d.qmid,'<?php echo $thisarray['p2'];?>','<?php echo $_SESSION['user'];?>','<?php echo $page;?>')" class="btn btn-light btn-sm bg waves-effect"><i class="mdi mdi-close"></i></button>
          <?php } ?>
          </div>
        </td>
      </tr>
