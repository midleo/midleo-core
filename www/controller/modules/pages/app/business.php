...
<div class="col-md-8"> <input type="text" name="conf#working_start" value="<?php echo isset($_POST['conf#working_start'])?$_POST['conf#working_start']:$website['working_start'];?>" class="form-control time-picker" id="workstart" data-bs-toggle="datetimepicker" data-target="#workstart" placeholder="Plese select the Hour"/></div>
  </div> 
  <div class="form-group row">
<label class="form-control-label text-lg-right col-md-4">Working end time</label>
<div class="col-md-8"> <input type="text" name="conf#working_end" value="<?php echo isset($_POST['conf#working_end'])?$_POST['conf#working_end']:$website['working_end'];?>" class="form-control time-picker" id="workend" data-bs-toggle="datetimepicker" data-target="#workend" placeholder="Please select the Hour"/></div>
  </div>
  </div>
