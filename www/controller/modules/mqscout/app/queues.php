                    ...
                    <div class="modal-content">
                        <form name="form" ng-app>
                            <div class="modal-body">
                                <div role="tabpanel">
                                    <ul class="nav nav-tabs customtab" role="tablist">
                                        ...
                                        <li class="nav-item"><a class="nav-link" href="#various" aria-controls="various"
                                                role="tab" data-bs-toggle="tab">Various</a></li>
                                        <li class="nav-item"
                                            ng-show="mq.type=='qlocal' || mq.type=='qremote' || mq.type=='qalias'"><a
                                                class="nav-link" href="#cluster" aria-controls="cluster" role="tab"
                                                data-bs-toggle="tab">Cluster</a></li>
                                        <li class="nav-item" ng-show="mq.type=='qlocal' || mq.type=='qmodel'"><a
                                                class="nav-link" href="#trigger" aria-controls="trigger" role="tab"
                                                data-bs-toggle="tab">Trigger</a></li>
                                        <li class="nav-item" ng-show="mq.type=='qlocal' || mq.type=='qmodel'"><a
                                                class="nav-link" href="#event" aria-controls="event" role="tab"
                                                data-bs-toggle="tab">Event</a></li>
                                    </ul>
                                    <br>
                                    <div class="tab-content container form-material"
                                        ...
                                        <input id="thisact" value="yes" type="text"
                                            ...
                                            <div class=" row">
                                                ...
                                                <div class="col-md-9"><input ng-maxlength="48" ng-model="mq.name"
                                            ...
                                            <div class=" row">
                                                ...
                                                <div class="col-md-9"><select class="form-control form-control-sm" ng-model="mq.type"
                                                        ng-minlength="1" ng-required="true">
                                                        <option value="">Please select</option>
                                                        <option value="qlocal"
                                                            ng-click="mq.distl='no';mq.qdploev='disabled';mq.qdphiev='disabled';mq.qdpmaxev='disabled';mq.qsvciev='none';mq.propctl='compat';mq.clwluseq='qmgr';mq.monq='qmgr';mq.distl='no';mq.trigger='notrigger';mq.get='enabled';mq.targtype='';mq.statq='qmgr';mq.defbind='notfixed';mq.usage='normal';mq.put='enabled';mq.defpsist='yes';">
                                                            Local</option>
                                                        <option value="qremote"
                                                            ng-click="mq.put='enabled';mq.defpsist='yes';mq.targtype='';mq.qdploev='';mq.qdphiev='';mq.qdpmaxev='';mq.qsvciev='';mq.propctl='';mq.clwluseq='';mq.monq='';mq.statq='';mq.distl='';mq.trigger='';mq.get='';mq.defbind='notfixed';mq.usage=''">
                                                            Remote</option>
                                                        <option value="qalias"
                                                            ng-click="mq.statq='';mq.distl='';mq.targtype='queue';mq.propctl='compat';mq.get='enabled';mq.defbind='notfixed';mq.usage='';mq.put='enabled';mq.defpsist='yes';mq.clwluseq='';">
                                                            Alias</option>
                                                        <option value="qmodel"
                                                            ng-click="mq.put='enabled';mq.defpsist='yes';mq.usage='normal';mq.defbind='';mq.propctl='compat';mq.qdploev='disabled';mq.qdphiev='disabled';mq.qdpmaxev='disabled';mq.qsvciev='none';mq.monq='qmgr';mq.distl='no';mq.trigger='notrigger';mq.get='enabled';mq.targtype='';mq.statq='qmgr';mq.clwluseq='';">
                                                            Model</option>
                                                    </select></div>
                                            </div>
                                            <div class=" row">
                                            ...
                                            <div class=" row"
                                                ng-show="mq.type=='qlocal' || mq.type=='qmodel'">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">Usage</label>
                                                <div class="col-md-9"><select class="form-control form-control-sm" ng-model="mq.usage">
                                                        <option value="">Please select</option>
                                                        <option value="normal">Normal</option>
                                                        <option value="xmitq">Transmission</option>
                                                    </select></div>
                                            </div>
                                            <div class=" row"
                                                ng-show="mq.type=='qlocal' || mq.type=='qremote' || mq.type=='qalias'">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">Cluster</label>
                                                <div class="col-md-9"><input ng-model="mq.cluster" type="text"
                                                        class="form-control form-control-sm"></div>
                                            </div>
                                            <div class=" row"
                                                ng-show="mq.type=='qlocal' || mq.type=='qremote' || mq.type=='qalias'">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">CLUSNL</label>
                                            ...
                                            <div class=" row"
                                                ng-show="mq.type=='qlocal' || mq.type=='qmodel'">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">MAXDEPTH</label>
                                                <div class="col-md-9"><input ng-model="mq.maxdepth" type="text"
                                                        class="form-control form-control-sm"></div>
                                            </div>
                                            <div class=" row">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">PUTENABLED</label>
                                                <div class="col-md-9"><select class="form-control form-control-sm" ng-model="mq.put">
                                                        <option value="">Please select</option>
                                                        <option value="enabled">Allowed</option>
                                                        <option value="disabled">Inhibited</option>
                                                    </select></div>
                                            </div>
                                            <div class=" row">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">GETENABLED</label>
                                                <div class="col-md-9"><select class="form-control form-control-sm" ng-model="mq.get">
                                                        <option value="">Please select</option>
                                                        <option value="enabled">Allowed</option>
                                                        <option value="disabled">Inhibited</option>
                                                    </select></div>
                                            ...
                                            <div class=" row"
                                                ng-show="mq.type=='qlocal' || mq.type=='qmodel'">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">BOQNAME</label>
                                                <div class="col-md-9"><input ng-model="mq.boqname" type="text"
                                                        class="form-control form-control-sm"></div>
                                            </div>
                                            <div class=" row"
                                                ng-show="mq.type=='qlocal' || mq.type=='qmodel'">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">BOTHRESH</label>
                                                <div class="col-md-9"><input ng-model="mq.bothresh" type="text"
                                                        class="form-control form-control-sm"></div>
                                            </div>
                                            <div class=" row" ng-show="mq.type=='qalias'">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">TARGET</label>
                                                <div class="col-md-9"><input ng-model="mq.target" type="text"
                                                        class="form-control form-control-sm"></div>
                                            </div>
                                            <div class=" row" ng-show="mq.type=='qremote'">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">RNAME</label>
                                                <div class="col-md-9"><input ng-model="mq.rname" type="text"
                                                        class="form-control form-control-sm"></div>
                                            </div>
                                            <div class=" row" ng-show="mq.type=='qremote'">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">RQMNAME</label>
                                                <div class="col-md-9"><input ng-model="mq.rqmname" type="text"
                                                        class="form-control form-control-sm"></div>
                                            </div>
                                            <div class=" row" ng-show="mq.type=='qremote'">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">XMITQ</label>
                                                <div class="col-md-9"><input ng-model="mq.xmitq" type="text"
                                                        class="form-control form-control-sm"></div>
                                            </div>
                                            <div class=" row">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">DEFBIND</label>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="default">
                                            <div class=" row">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">DEFPRTY</label>
                                                <div class="col-md-9"><input ng-model="mq.defprty" type="text"
                                                        class="form-control form-control-sm"></div>
                                            </div>
                                            <div class=" row">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">DEFPSIST</label>
                                                <div class="col-md-9"><select class="form-control form-control-sm"
                                                        ng-model="mq.defpsist">
                                                        <option value="">Please select</option>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="various">
                                            ...
                                            <div class=" row"
                                                ng-show="mq.type=='qlocal' || mq.type=='qmodel' || mq.type=='qalias'">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">PROPCTL</label>
                                                <div class="col-md-9"><select class="form-control form-control-sm"
                                                        ng-model="mq.propctl">
                                                        <option value="">Please select</option>
                                                        ...
                                                        <option value="v6compat">V6COMPAT</option>
                                                    </select></div>
                                            </div>
                                            <div class=" row" ng-show="mq.type=='qalias'">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">TARGTYPE</label>
                                                <div class="col-md-9"><select class="form-control form-control-sm"
                                                        ng-model="mq.targtype">
                                                        <option value="">Please select</option>
                                            ...
                                            <div class=" row"
                                                ng-show="mq.type=='qlocal' || mq.type=='qmodel'">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">INITQ</label>
                                                <div class="col-md-9"><input ng-model="mq.initq" type="text"
                                                        class="form-control form-control-sm"></div>
                                            </div>
                                            <div class=" row">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">STATQ</label>
                                                <div class="col-md-9"><select class="form-control form-control-sm" ng-model="mq.statq">
                                                        <option value="">Please select</option>
                                            ...
                                            <div class=" row"
                                                ng-show="mq.type=='qlocal' || mq.type=='qmodel'">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">MONQ</label>
                                                <div class="col-md-9"><select class="form-control form-control-sm" ng-model="mq.monq">
                                                        <option value="">Please select</option>
                                                        <option value="qmgr">QMGR</option>
                                                        <option value="off">OFF</option>
                                            ...
                                            <div class=" row">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">DISTL</label>
                                                <div class="col-md-9"><select class="form-control form-control-sm" ng-model="mq.distl">
                                                        <option value="">Please select</option>
                                                        <option value="qmgr">NO</option>
                                                        <option value="yes">YES</option>
                                                        <option value="high">HIGH</option>
                                                    </select></div>
                                            </div>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="cluster"
                                            ...
                                            <div class=" row"
                                                ng-show="mq.type=='qlocal' || mq.type=='qremote' || mq.type=='qalias'">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">CLWLRANK</label>
                                                <div class="col-md-9"><input ng-model="mq.clwlrank" type="text"
                                                        class="form-control form-control-sm"></div>
                                            </div>
                                            <div class=" row" ng-show="mq.type=='qlocal'">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">CLWLUSEQ</label>
                                                <div class="col-md-9"><select class="form-control form-control-sm"
                                                        ng-model="mq.clwluseq">
                                                        <option value="">Please select</option>
                                                        <option value="qmgr">QMGR</option>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="trigger"
                                            ng-show="mq.type=='qlocal' || mq.type=='qmodel'">
                                            <div class=" row">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">TRIGGER</label>
                                                <div class="col-md-9"><select class="form-control form-control-sm"
                                                        ng-model="mq.trigger">
                                                        <option value="">Please select</option>
                                                        <option value="notrigger">NOTRIGGER</option>
                                                        <option value="trigger">TRIGGER</option>
                                                    </select></div>
                                            </div>
                                            <div class=" row">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">PROCESS</label>
                                                <div class="col-md-9"><input ng-model="mq.process" type="text"
                                                        class="form-control form-control-sm"></div>
                                            </div>
                                            <div class=" row">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">TRIGDATA</label>
                                                <div class="col-md-9"><input ng-model="mq.trigdata" type="text"
                                                        class="form-control form-control-sm"></div>
                                            </div>
                                            <div class=" row">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">TRIGTYPE</label>
                                                <div class="col-md-9"><select class="form-control form-control-sm"
                                                        ng-model="mq.trigtype">
                                                        <option value="">Please select</option>
                                                        <option value="none">NONE</option>
                                            ...
                                            <div class=" row">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">TRIGDPTH</label>
                                                <div class="col-md-9"><input ng-model="mq.trigdpth" type="text"
                                                        class="form-control form-control-sm"></div>
                                            </div>
                                            <div class=" row">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">TRIGMPRI</label>
                                                <div class="col-md-9"><input ng-model="mq.trigmpri" type="text"
                                                        class="form-control form-control-sm"></div>
                                            </div>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="event"
                                            ...
                                            <div class=" row">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">QDEPTHHI</label>
                                                <div class="col-md-9"><input ng-model="mq.qdepthhi" type="text"
                                                        class="form-control form-control-sm"></div>
                                            </div>
                                            <div class=" row">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">QDPHIEV</label>
                                                <div class="col-md-9"><select class="form-control form-control-sm"
                                                        ng-model="mq.qdphiev">
                                                        <option value="">Please select</option>
                                            ...
                                            <div class=" row">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">QDEPTHLO</label>
                                                <div class="col-md-9"><input ng-model="mq.qdepthlo" type="text"
                                                        class="form-control form-control-sm"></div>
                                            </div>
                                            <div class=" row">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">QDPLOEV</label>
                                                <div class="col-md-9"> <select class="form-control form-control-sm"
                                                        ng-model="mq.qdploev">
                                                        <option value="">Please select</option>
                                                        <option value="disabled">Disabled</option>
                                            ...
                                            <div class=" row">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-html="true">QDPMAXEV</label>
                                                <div class="col-md-9"><select class="form-control form-control-sm"
                                                        ng-model="mq.qdpmaxev">
                                                        <option value="">Please select</option>
                                                        <option value="disabled">Disabled</option>
                                                        <option value="enabled">Enabled</option>
                                                    </select></div>
                            ...
                            <div class="modal-footer" style="display:flow-root list-item;">
                                <div class="float-start"><a href="https://www.google.com/search?q=ibm+mq+define+queues"
                                        target="_blank"
