                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="base">
                                            ...
                                            <div class="form-group row">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    ...
                                                    data-content="If this object is active.<br> Default - yes.<br>If NO, it will not appear in the builds"
                                                    title="" data-original-title="Active">Active</label>
                                            ...
                                            <div class="form-group row">
                                                <label class="form-control-label text-lg-right col-md-3"
                                                    data-trigger="hover" data-bs-toggle="popover"
                                                    data-bs-placement="top" data-html="true"
                                                    data-content="Qmanager name" title="" data-original-title="Qmanager"
                                                    ng-class="{'has-error':!mq.qm}">QMGR</label>
                                                <div class="col-md-9">
                                                    <?php 
