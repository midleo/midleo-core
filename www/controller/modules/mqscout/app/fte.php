...
<div class="row">
                    ...
                    <tr id="contloaded" class="hide"
                        ...
                        <td class="text-center">
                            <div class="toggle-switch">
                                <input id="deplqmid{{ d.id }}" type="checkbox" class="checkall" value="{{ d.id }}"
                        ...
                        <td class="text-center">
                            {{ d.mqftename | limitTo:textlimit }}{{d.mqftename.length > textlimit ? '...' : ''}}</td>
                        <td class="text-center">
                            {{ d.sourceagt | limitTo:textlimit }}{{d.sourceagt.length > textlimit ? '...' : ''}}</td>
                        <td class="text-center">
                            {{ d.sourcedir | limitTo:textlimit }}{{d.sourcedir.length > textlimit ? '...' : ''}}</td>
                        <td class="text-center">
                            {{ d.destagt | limitTo:textlimit }}{{d.destagt.length > textlimit ? '...' : ''}}</td>
                        <td class="text-center">
                            {{ d.destdir | limitTo:textlimit }}{{d.destdir.length > textlimit ? '...' : ''}}</td>
                        <td class="text-center">
                            <div class="text-start d-grid gap-2 d-md-block">
                                <button type="button"
                                    ng-click="readOnefte('<?php echo $thisarray['p2'];?>',d.fteid,'env')" style=""
                                ...
                                <?php if($_SESSION['user_level']>="3"){?><button type="button"
                                    ng-click="deletefte('<?php echo $thisarray['p2'];?>',d.fteid,'<?php echo $_SESSION['user'];?>','env')"
                                    class="btn btn-light btn-sm bg waves-effect"><i
                            ...
                            <div class="modal-body">
                                <div role="tabpanel">
                                    <ul class="nav nav-tabs customtab" role="tablist">
                                        ...
                                        <li class="nav-item"><a class="nav-link" href="#info" aria-controls="info"
                                                role="tab" data-bs-toggle="tab">Comment</a></li>
                                    </ul><br>
                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="base">
                                            <div class=" row">
                                                ...
                                                <div class="col-md-8"><select class="form-control form-control-sm" ng-required="true"
                                                        ...
                                                        <option value="f2q">File to Queue</option>
                                                        <option value="q2f">Queue to File</option>
                                                    </select></div>
                                                <div class="col-md-1" style="padding-left:0px;"><button type="button"
                                                        class="btn btn-light" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                        title="There are three types of file transfers. File to File - source and destination are files. Queue to File - source is a queue and destination - file. File to Queue - source is a file and destination - Queue"><i
                                            ...
                                            <div class=" row">
                                                ...
                                                <div class="col-md-1" style="padding-left:0px;"><button type="button"
                                                        class="btn btn-light" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                        title="Number of files in one transfer.<br>Default is 1"><i
                                                            class="mdi mdi-information-variant mdi-18px"></i></button>
                                                </div>
                                            </div>
                                            <div class=" row">
 ...
 ?>
                                                ...
                                                <div class="col-md-1" style="padding-left:0px;"><button type="button"
                                                        class="btn btn-light" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                        title="The name of the Source FTE agent"><i
                                                            class="mdi mdi-information-variant mdi-18px"></i></button>
                                                </div>
                                            </div>
                                            <div class=" row">
 ...
 ?>
                                                ...
                                                <div class="col-md-1" style="padding-left:0px;"><button type="button"
                                                        class="btn btn-light" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                        title="The name of the Source FTE agent Qmanager"><i
                                                            class="mdi mdi-information-variant mdi-18px"></i></button>
                                                </div>
                                            </div>
                                            <div class=" row">
 ...
 ?>
                                                ...
                                                <div class="col-md-1" style="padding-left:0px;"><button type="button"
                                                        class="btn btn-light" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                        title="The name of the Destination FTE agent"><i
                                                            class="mdi mdi-information-variant mdi-18px"></i></button>
                                                </div>
                                            </div>
                                            <div class=" row">
 ...
 ?>
                                                ...
                                                <div class="col-md-1" style="padding-left:0px;"><button type="button"
                                                        class="btn btn-light" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                        title="The name of the Destination FTE agent Qmanager"><i
                                                            class="mdi mdi-information-variant mdi-18px"></i></button>
                                                </div>
                                            </div>
                                            <div class=" row">
                                                ...
                                                <div class="col-md-1" style="padding-left:0px;"><button type="button"
                                                        class="btn btn-light" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                        title="After successfull transfer you can select either to delete or leave the source file"><i
                                                            class="mdi mdi-information-variant mdi-18px"></i></button>
                                                </div>
                                            </div>
                                            <div class=" row">
                                                ...
                                                <div class="col-md-1" style="padding-left:0px;"><button type="button"
                                                        class="btn btn-light" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                        title="The type of the transfer - text or binary"><i
                                                            class="mdi mdi-information-variant mdi-18px"></i></button>
                                                </div>
                                            </div>
                                            ...
                                            <div class=" row" ng-show="mqfte.textorbinary=='text'">
                                                ...
                                                <div class="col-md-1" style="padding-left:0px;"><button type="button"
                                                        class="btn btn-light" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                        title="The CCSID of the destination file"><i
                                                            class="mdi mdi-information-variant mdi-18px"></i></button>
                                                </div>
                                            </div>
                                            <div class=" row"
                                                ...
                                                <div class="col-md-1" style="padding-left:0px;"><button type="button"
                                                        class="btn btn-light" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                        title="The directory name from where the file will be taken"><i
                                                            class="mdi mdi-information-variant mdi-18px"></i></button>
                                                </div>
                                            </div>
                                            <div class=" row"
                                                ...
                                                <div class="col-md-1" style="padding-left:0px;"><button type="button"
                                                        class="btn btn-light" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                        title="The file pattern that will trigger the transfer"><i
                                                            class="mdi mdi-information-variant mdi-18px"></i></button>
                                                </div>
                                            </div>
                                            <div class=" row"
                                                ...
                                                <div class="col-md-1" style="padding-left:0px;"><button type="button"
                                                        class="btn btn-light" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                        title="is the file pattern regular expression"><i
                                                            class="mdi mdi-information-variant mdi-18px"></i></button>
                                                </div>
                                            </div>
                                            <div class=" row" ng-show="mqfte.mqftetype=='q2f'">
                                                ...
                                                <div class="col-md-1" style="padding-left:0px;"><button type="button"
                                                        ...
                                                        title="The queue name which will be monitored for messages<br>Note that queue should be visible from the source agent qmanager"><i
                                                            class="mdi mdi-information-variant mdi-18px"></i></button>
                                                </div>
                                            </div>
                                            <div class=" row"
                                                ...
                                                <div class="col-md-1" style="padding-left:0px;"><button type="button"
                                                        class="btn btn-light" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                        title="The name of directory on destination side"><i
                                                            class="mdi mdi-information-variant mdi-18px"></i></button>
                                                </div>
                                            </div>
                                            <div class=" row"
                                                ...
                                                <div class="col-md-1" style="padding-left:0px;"><button type="button"
                                                        class="btn btn-light" data-bs-toggle="tooltip"
                                                        data-bs-placement="top" data-html="true"
                                                        title="The file name on destination side<br>Default is ${FileName}"><i
                                                            class="mdi mdi-information-variant mdi-18px"></i></button>
                                                </div>
                                            </div>
                                            <div class=" row" ng-show="mqfte.mqftetype=='f2q'">
                                                ...
                                                <div class="col-md-1" style="padding-left:0px;"><button type="button"
                                                        class="btn btn-light" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                        title="The queue name to which messages will be transferred. Note that queue should be visible from the destination agent qmanager"><i
                                                            class="mdi mdi-information-variant mdi-18px"></i></button>
                                                </div>
                                            </div>
                                            <div class=" row" ng-show="mqfte.mqftetype!='q2f'">
                                                ...
                                                <div class="col-md-1" style="padding-left:0px;"><button type="button"
                                                        class="btn btn-light" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                        title="Post source command that will be triggered after successfull transfer. Triggering is on source side"><i
                                                            class="mdi mdi-information-variant mdi-18px"></i></button>
                                                </div>
                                            </div>
                                            <div class=" row" ng-show="mqfte.mqftetype!='q2f'">
                                                ...
                                                <div class="col-md-1" style="padding-left:0px;"><button type="button"
                                                        class="btn btn-light" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                        title="Arguments that will be passed to the command. Please use interval between each argument"><i
                                                            class="mdi mdi-information-variant mdi-18px"></i></button>
                                                </div>
                                            </div>
                                            <div class=" row" ng-show="mqfte.mqftetype!='f2q'">
                                                ...
                                                <div class="col-md-1" style="padding-left:0px;"><button type="button"
                                                        class="btn btn-light" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                        title="Post destination command that will be triggered after successfull transfer. Triggering is on destination side"><i
                                                            class="mdi mdi-information-variant mdi-18px"></i></button>
                                                </div>
                                            ...
                                            <div class=" row" ng-show="mqfte.mqftetype!='f2q'">
                                                ...
                                                <div class="col-md-1" style="padding-left:0px;"><button type="button"
                                                        class="btn btn-light" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                        title="Post Destination Command arguments. Arguments that will be passed to the command. Please use interval between each argument"><i
                                                            class="mdi mdi-information-variant mdi-18px"></i></button>
                                                </div>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="info">
                                            <div class=" row">
                                                ...
                                                <div class="col-md-1" style="padding-left:0px;"><button type="button"
                                                        class="btn btn-light" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                        title="Additional information about this transfer. Email, requestor, references, that will help you finding it in future"><i
                                                            class="mdi mdi-information-variant mdi-18px"></i></button>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" id="btn-conf-fte"
                                    class="waves-effect waves-light btn btn-info btn-sm"
                                    ng-click="fteconf('<?php echo $thisarray['p2'];?>','env')" ng-href="{{ url }}"><i
                                        class="mdi mdi-download"></i>&nbsp;Create config</button>
                                <?php if($_SESSION['user_level']>="3"){?>
                                <button type="button" id="btn-create-fte"
                                    class="waves-effect waves-light btn btn-info btn-sm"
                                    ng-click="createfte('<?php echo $thisarray['p2'];?>','<?php echo $_SESSION['user'];?>','env')"><i
                                        class="mdi mdi-check"></i>&nbsp;Create</button>
                                <button type="button" id="btn-update-fte"
                                    class="waves-effect waves-light btn btn-info btn-sm"
                                    ng-click="updatefte('<?php echo $thisarray['p2'];?>','<?php echo $_SESSION['user'];?>','env')"><i
 ...
 ?>
                            ...
                            <div class="modal-footer">
                                <button ng-show="depl.deplenv" type="button"
                                    class="waves-effect waves-light btn btn-light btn-sm"
                                    ng-click="createjob('<?php echo $thisarray['p2'];?>','fte','mqenv_mqfte','','')"><i
                                        class="mdi mdi-play-circle-outline"></i>&nbsp;Create job</button>
                                <button ng-show="depl.deplenv" type="button"
                                    ng-click="form.$valid && deployMQftesel('<?php echo $thisarray['p2'];?>');"
            ...
            <div class="modal" id="modal-deplfte-response" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog" style="width:1000px;">
                    <div class="modal-content">
                        <div class="modal-body"
                            style="width:100%;max-height:500px;overflow-x:hidden;overflow-y:scroll;padding: 3px;">
                            <pre>
