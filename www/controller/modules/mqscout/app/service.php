                    ...
                    <tr id="contloaded" class="hide"
                        ...
                        <td class="text-center">
                            <div class="text-start d-grid gap-2 d-md-block">
                                ...
                                <button type="button"
                                    ng-click="delete('<?php echo $page=="mqscout"?$thisarray['p1']:$thisarray['p3'];?>',d.qid,d.qmid,'<?php echo $thisarray['p2'];?>','<?php echo $page;?>')"
                                    class="btn btn-light btn-sm bg waves-effect"><i class="mdi mdi-close"></i></abutton>
                                    <?php } ?>
                            </div>
                        </td>
                    </tr>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4>Define Service definition</h4>
                        </div>
...
$stmt->execute(array($thisarray['p2']));
 ...
 ?>
                                    ...
                                    <div class="form-group row">
                                        <label class="form-control-label text-lg-right col-md-3"
                                            ng-class="{'has-error':!mq.name}">Service Name</label>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9"><input ng-maxlength="64" ng-model="mq.descr" type="text"
                                                class="form-control"></div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="form-control-label text-lg-right col-md-3"
                                            ng-class="{'has-error':!mq.startcmd}">STARTCMD</label>
                                        <div class="col-md-9"><input ng-model="mq.startcmd" ng-required="true"
                                                type="text" class="form-control"></div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="form-control-label text-lg-right col-md-3">STARTARG</label>
                                        <div class="col-md-9"><input ng-model="mq.startarg" type="text"
                                                class="form-control"></div>
                                    </div>
                            ...
                            <div class="modal-footer" style="display:flow-root list-item;">
                                <div class="float-start"><a href="https://www.google.com/search?q=ibm+mq+define+service"
                                        target="_blank"
                                ...
                                <div class="float-end">
                                    ...
                                    <button type="button" id="btn-mqsc-obj"
                                        ...
                                        ng-click="mqsc('<?php echo $page=="mqscout"?$thisarray['p1']:$thisarray['p3'];?>','<?php echo $thisarray['p2'];?>','<?php echo $_SESSION['user'];?>','<?php echo $page;?>')"
