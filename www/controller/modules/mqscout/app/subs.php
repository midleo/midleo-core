                        ...
                        <form name="form" ng-app>
                            <div class="modal-body container form-material"
                                ...
                                <div class=" row">
                                    ...
                                    <div class="col-md-9"><input ng-model="mq.dest" type="text" class="form-control form-control-sm">
                                    </div>
                                </div>
                                <div class=" row">
                                ...
                                <div class=" row">
                                    ...
                                    <div class="col-md-9"><textarea ng-model="mq.selector" class="form-control form-control-sm"
                                            rows="3"></textarea></div>
                                </div>
